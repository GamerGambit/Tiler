...
{
	public class MainGame : Tiler.GSM.GameState
	{
		...
		public MainGame(Tiler.GSM.GameStateStack gameStateStack) : base(gameStateStack)
		{
			GameView = new View(GameStateContext.Window.RenderWindow.GetView());
			...
			using (var MapBmp = new Bitmap("data/map.png"))
			{
		...
		{
			GameStateContext.Window.RenderWindow.SetView(GameView);
			World.Draw(GameStateContext.Window);

			Player.Draw(GameStateContext.Window.RenderWindow, RenderStates.Default);
		}
	}
}
